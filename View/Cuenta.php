				...
				<section id="intro" class="wrapper style1">
					...
					<div class="container">
						<header class="style1">
							...
							<form method="post" action="../Controller/DataCreationUser.php" name="FormUser">
								<div class="row gtr-50">
										<!--       ############          -->  
									<div class="col-6 col-12-small">
										<input  require type="text" name="nombre" id="contact-name" placeholder="Nombre" />
									</div><!--                 -->
									<div class="col-6 col-12-small">
										<input  require type="text" name="usuario" id="contact-user" placeholder="Usuario" />
                                    </div><!--                 -->
                                    <div class="col-6 col-12-small">
										<input require type="email" name="correo" id="contact-name" placeholder="Correo Electronico" />
									</div>
									<!--       ############          -->
                                    <div class="col-6 col-12-small">
										<input type="text" name="telefono" id="contact-email" placeholder="Telefono" />
                                    </div>
                                    <div class="col-6 col-12-small">
										<input type="text" name="direccion" id="contact-email" placeholder="Direccion" />
                                    </div>
                                    <div class="col-6 col-12-small">
										<input require type="password" name="pass" id="contact-email" placeholder="Contraseña" />
									</div>
										<!--       ############          -->
									<div class="col-6 col-12-small">
										<input type="text" name="Numsocio" id="contact-Numsocio" placeholder="Numero de Socio CANACO" />
									</div>
									<div class="col-12">
										<ul class="actions">
											<li><input type="submit" class="style3" value="Registrate"/></li>
										</ul>
									</div>
								</div>
							</form>
