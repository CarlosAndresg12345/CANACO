				...
				<section id="intro" class="wrapper style1">
					...
					<div class="container">
						<header class="style1">
							...
							<form method="post" action="../Controller/DataEventos.php" name="FormUser" enctype="multipart/form-data">
								<div class="row gtr-50">
                                    <input type="hidden" value="<?php  echo $_SESSION['usuario'];?>" name="usuario">
                                     
									<div class="col-6 col-12-small">
										<input type="text" name="nombreEvento" id="contact-name" placeholder="Nombre del Evento" />
                                    </div>    
									<div class="col-6 col-12-small">
										<input type="text"  id="contact-name"name="direccion" placeholder="Direccion de Del Evento"  />
                                    </div>                                
                                    <div class="col-6 col-12-small">
                                        <textarea name="descripcion" placeholder="Descripcio de Del Evento"></textarea>
                                    </div>
									<div class="col-6 col-12-small">
									...
									<div class="col-6 col-12-small">
									    <p>Fecha de Inicio</p>
										<input type="date" step="5"  name="FechaInicio" id="contact-name" />
                                    </div>
									<div class="col-6 col-12-small">
									    <p>Fecha de Inicio</p>
										<input type="date" step="5"  name="FechaFinalizacion" id="contact-name"  />
                                    </div>
