		...
		<div id="logo">
                ...
                <div class="title">Formulario de Registro</div>
					<div class="container">
						<header class="style1">
							...
							<form method="post" action="../Controller/DataCreacionDeSocios.php" name="FormUser">
								<div class="row gtr-50">
									...
									<div class="col-6 col-12-small">
										<input require type="text" name="empresa" id="contact-user" placeholder="Nombre de la Empresa" />
                                    </div><!--                 -->
                                    <div  class="col-6 col-12-small" name="giro">
                                        <select  name="giro">
                                            <option value="Restaurante" >Restaurante</option>
                                            <option value="Ropa" selected>Ropa</option>
                                            <option value="Subenir">Subenir </option>
											<option value="Servicio">Subenir </option>
                                        </select>
                                    </div>
                                    <div require  class="col-6 col-12-small">
										<input type="number" name="numeros" id="contact-name" placeholder="NumerideSocio" />
									</div>
									<!--       ############          -->
			...
			<!-- Highlights -->
				<section id="intro" class="wrapper style1">
					...
					<div class="title">Socios Registrados</div>
                    <div class="container">
                    <table >
                            <thead>
                                <th> </th>
