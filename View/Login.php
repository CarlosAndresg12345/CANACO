				...
				<section id="intro" class="wrapper style1">
					...
					<div class="container">
						<header class="style1">
							...
							<form method="post" action="../Controller/DataLogin.php">
								<div class="row gtr-50">
									<div class="col-6 col-12-small">
										<input type="text" name="Usuario" id="contact-name" placeholder="Usuario" />
									</div>
									<div class="col-6 col-12-small">
										<input type="password" name="passwd" id="contact-email" placeholder="Password" />
									</div>
									<div class="col-12">
										<ul class="actions">
											<li><input type="submit" class="style3" value="Iniciar" /></li>
												<li><input type="reset" class="style3" value="Limpiar" /></li>
										</ul>
									</div>
									<div class="col-12">
										<ul class="actions">
											<li><a href="Cuenta.php"><input type="button" class="style3" value="Registrate"/></a></li>
										</ul>
									</div>
								</div>
							</form>
